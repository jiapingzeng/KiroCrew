 ...
 *   - challenge seen, no runtime grant   -> "Sign-in required" + Authorize
 *   - challenge seen, grant held         -> "Not verified" (nothing to do here)
 ...
 * gateway reports; it must keep the vaguer wording rather than being told to sign in.
 *
...
const servers = [
  ...
  // Authorized through Kiro CLI: the probe still cannot see it, so the honest
  // wording stays "Not verified" and no action is offered.
  {
    name: 'linear',
    command: '',

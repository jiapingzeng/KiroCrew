 ...
 * labelKey resolves in the English catalogs, and throws otherwise.
 *
 * Contract per entry: `label` is the English catalog string for `labelKey`
 * (the registry is an English search corpus), and SecurityPanel.tsx carries a
 ...
 * locale.
 */
export const SETTINGS_MANUAL: SettingEntry[] = [
  {

        ...
        <div className="mc-fe-viewer-actions">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="min-w-[190px]">
              {/* Open/Reveal are gated on directLocal (the browser is on the
                  gateway machine) — a remote session gets Download only, so it
                  never sees a "reveal" that would open Finder on a host it is
                  not looking at. Failures funnel through the shared i18n path. */}
              {directLocal && (

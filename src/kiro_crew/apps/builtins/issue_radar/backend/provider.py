...
class ProviderClient(Protocol):
    ...
    # succeeds"), so both raise there. Azure DevOps expresses all three review
    # verbs as reviewer votes and has a genuinely reversible arming verb, so it
    # implements them -- see the sections in each client.
    def set_pr_state(
